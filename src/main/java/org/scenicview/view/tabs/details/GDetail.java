...
public class GDetail {
	...
	public void setValue(final String value2) {
		switch (detail.getValueType()) {
			case COLOR, NORMAL -> ((Label) value).setText(value2);
			case INSETS -> ((InsetsDisplay) value).setInsetsTarget(ConnectorUtils.deserializeInsets(value2));
			case CONSTRAINTS -> ((ConstraintsDisplay) value).setPropertiesMap(ConnectorUtils.deserializeMap(value2));
